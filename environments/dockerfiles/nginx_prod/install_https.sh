#!/bin/bash
#docker exec nginx certbot certonly --nginx --email sistemas@educalegal.com.br --agree-tos --non-interactive --expand -d app.educalegal.com.br -d api.educalegal.com.br -d generation.educalegal.com.br -d production.educalegal.com.br -d apiflower.educalegal.com.br -d apimongoexpress.educalegal.com.br -d apirabbitmq.educalegal.com.br
docker exec nginx certbot certonly --nginx --email sistemas@educalegal.com.br --agree-tos --non-interactive -d app.educalegal.com.br -d api.educalegal.com.br -d production.educalegal.com.br -d apiflower.educalegal.com.br -d apimongoexpress.educalegal.com.br -d apirabbitmq.educalegal.com.br
