    ...
    return {
      ...
      escolaSteps: [
        ...
        },
        {
          ...
          content: `Você pode apagar uma escola apenas se ainda não houver criado nenhum documento para ela. Uma vez criados documentos, a escola fica cadastrada permanentemente.`,
          params: {
            placement: "top",
            enableScrolling: false
          }
