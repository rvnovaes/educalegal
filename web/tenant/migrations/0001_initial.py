    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "provider",
                    models.CharField(
                        default="Docusign", max_length=255, verbose_name="Fornecedor"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "token",
                    models.CharField(max_length=255, verbose_name="Token da API"),
                ),
                (
                    "database",
                    models.CharField(max_length=255, verbose_name="Banco de Dados"),
                ),
                (
                    "database_user",
                    models.CharField(
                ...
                (
                    "storage_access_key",
                    models.CharField(max_length=255, verbose_name="Access Key Token"),
                ),
                (
                    "storage_secret_key",
                    models.CharField(max_length=255, verbose_name="Secret Key"),
                ),
                (
                    "storage_bucket_name",
                    models.CharField(max_length=255, verbose_name="Nome do Bucket"),
                ),
                (
                    "storage_default_acl",
                    models.CharField(
                        default="private", max_length=255, verbose_name="ACL padrão"
                    ),
                ),
                (
                    "storage_endpoint_url",
                    models.CharField(max_length=255, verbose_name="URL do Endpoint"),
                ),
                (
                    "storage_region_name",
                    models.CharField(max_length=255, verbose_name="Região"),
                ),
            ],
        ),
