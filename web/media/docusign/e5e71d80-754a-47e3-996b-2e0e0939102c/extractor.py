...
if __name__ == "__main__":
    ...
    with open("2020-02-29T10_38_43.8850606.xml", "r") as file:
        print(docusign_xml_parser(file.read())["envelope_all_details_message"])

    with open("2020-02-29T10_39_54.252039.xml", "r") as file:
        print(docusign_xml_parser(file.read())["envelope_all_details_message"])

    with open("2020-02-29T10_40_34.7661534.xml", "r") as file:
        print(docusign_xml_parser(file.read())["envelope_all_details_message"])
