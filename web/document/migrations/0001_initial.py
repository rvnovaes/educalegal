    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "altered_date",
                    models.DateTimeField(auto_now=True, verbose_name="Alteração"),
                ),
                (
                    "signing_provider",
                    models.CharField(max_length=256, verbose_name="Provedor"),
                ),
                (
                    "envelope_id",
                    models.CharField(max_length=256, verbose_name="Id do Envelope"),
                ),
                ("status", models.CharField(max_length=256, verbose_name="Status")),
                (
                    "ged_id",
                    models.CharField(
                        max_length=128, verbose_name="ID do Documento no GED"
                    ),
                ),
