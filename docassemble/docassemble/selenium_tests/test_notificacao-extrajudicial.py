...
class TestNotificaoExtrajudicial(WebTest):
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("https://generation.educalegal.com.br/","maria.secretaria@educalegal.com.br", "silex@568", "Notificação de cobrança"),

        ],
    )
    def test_notificaoExtrajudicial(self, server, user, password, document_name):
        ...
        self.wait.until(
            EC.text_to_be_present_in_element(
                (By.XPATH, "//h1"), "Dados do(a) notificado"
            )
        )
        self.driver.find_element(
        ...
        self.driver.find_element(By.XPATH, "//button[contains(.,'Continuar')]").click()
        self.wait.until(
            EC.text_to_be_present_in_element((By.XPATH, "//h1"), "Dados do financeiro")
        )
        self.driver.find_element(
            By.XPATH, "//form[@id='daform']/div[2]/div/input"
