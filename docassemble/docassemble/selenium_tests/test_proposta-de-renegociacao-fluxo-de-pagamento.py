...
class TestPropostaderenegociacaofluxodepagamento(WebTest):
    ...
    if RUN_TESTS_AUTOTEST:
        environment.append(("https://test.educalegal.com.br/", "autotest@educalegal.com.br", "Silex2109",
                            "Autotest_Proposta de renegociação - Postergação do Fluxo de Pagamento"),)
    if RUN_TESTS_PRODUCTION:
        environment.append(("https://app.educalegal.com.br/", "maria.secretaria@educalegal.com.br", "silex@568",
                            "Proposta de renegociação - Postergação do Fluxo de Pagamento"),)

    @pytest.mark.parametrize("server,user,password,document_name", environment,)
    def test_propostaderenegociacaofluxodepagamento(self, server, user, password, document_name):
        ...
        self.driver.find_element(By.XPATH, "//button[contains(.,\'Continuar\')]").click()
        self.wait.until(
            EC.text_to_be_present_in_element((By.XPATH, "//h1"), "Fluxo de Pagamento"))
        self.driver.find_element(By.XPATH, "//form[@id=\'daform\']/div[2]/p/span/input").send_keys("2")
        self.driver.find_element(By.XPATH, "//form[@id=\'daform\']/div[2]/p/span[2]/input").send_keys("2020-07-23")
        self.driver.find_element(By.XPATH, "//button[contains(.,\'Continuar\')]").click()
        self.wait.until(
