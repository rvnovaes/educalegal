...
class TestContratodoaluno(WebTest):
    @pytest.mark.parametrize(
        ...
        [
            ("https://test.educalegal.com.br/","autotest@educalegal.com.br","Silex2109","Autotest_Contrato de Prestação de Serviços Educacionais"),
            ("https://app.educalegal.com.br/","maria.secretaria@educalegal.com.br","silex@568","Contrato de Prestação de Serviços Educacionais"),
