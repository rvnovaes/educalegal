...
class TestContratodePrestaodeServios(WebTest):
    ...
    if RUN_TESTS_AUTOTEST:
        environment.append(("https://apptest.educalegal.com.br/", "autotest@educalegal.com.br", "Silex2109",
                            "Autotest_Contrato de prestação de serviços com ou sem cessão de mão de obra"),)
    if RUN_TESTS_PRODUCTION:
        environment.append(("https://app.educalegal.com.br/", "maria.secretaria@educalegal.com.br", "silex@568",
                            "Contrato de prestação de serviços com ou sem cessão de mão de obra"),)
    ...
    def test_contratodePrestaodeServios(self, server, user, password, document_name):
        ...
        self.driver.find_element(By.XPATH, "//form[@id=\'daform\']/div[6]/div/div/input").send_keys("4234234234")
        self.driver.find_element(By.XPATH, "//form[@id=\'daform\']/div[8]/div/div/fieldset/label").click()
        self.driver.find_element(By.XPATH, "//form[@id=\'daform\']/div[9]/div/div/input").send_keys("professor")
