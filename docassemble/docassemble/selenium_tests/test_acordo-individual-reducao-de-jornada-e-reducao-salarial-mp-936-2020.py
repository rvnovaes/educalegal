...
class TestAcordoIndividualReduodeJornadaeReduoSalarial(WebTest):
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("https://app.educalegal.com.br/","autotest@educalegal.com.br","Silex2109","Autotest_Acordo Individual de Trabalho - Redução de Jornada/Redução Salarial MP 936-2020"),
