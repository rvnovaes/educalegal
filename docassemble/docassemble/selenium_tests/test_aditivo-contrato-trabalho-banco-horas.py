...
class TestAditivoaocontratodetrabalhobancodehoras(WebTest):
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("https://generation.educalegal.com.br/","maria.secretaria@educalegal.com.br", "silex@568", "Aditivo ao contrato de trabalho - banco de horas"),
    ...
    def test_aditivoaocontratodetrabalhobancodehoras(self, server, user, password, document_name):
        ...
        self.wait.until(
            EC.text_to_be_present_in_element(
                (By.XPATH, "//h1"), "Dados do(a) Trabalhador"
            )
        )
        self.driver.find_element(
        ...
        ).send_keys("2435435435")
        self.driver.find_element(
            By.XPATH, "//form[@id='daform']/div[7]/div/fieldset/label"
        ).click()
        self.driver.find_element(
