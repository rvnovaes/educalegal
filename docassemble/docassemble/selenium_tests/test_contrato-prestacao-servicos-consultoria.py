...
class TestContratodeConsultoria(WebTest):
    @pytest.mark.parametrize(
        ...
        [
            ("https://test.educalegal.com.br/","autotest@educalegal.com.br","Silex2109","Autotest_Contrato de consultoria"),
            # ("https://generation.educalegal.com.br/","maria.secretaria@educalegal.com.br", "silex@568", "Contrato de consultoria"),
